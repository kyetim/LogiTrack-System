...
export function Sidebar({ className }: SidebarProps) {
    ...
    return (
        <div
            className={cn(
                'relative flex flex-col h-full bg-sidebar text-sidebar-foreground border-r border-sidebar-border/10 transition-all duration-300',
                collapsed ? 'w-20' : 'w-72',
                className
            )}
        >
                ...
                {routes.map((route) => (
                    <Link
                        ...
                        className={cn(
                            ...
                            pathname === route.href
                                ? 'bg-sidebar-primary text-sidebar-primary-foreground shadow-lg shadow-sidebar-primary/20 scale-105'
